...
//            // 提交市价单接口
            System.out.println(service.buyMarket(1, "0.00389109903314", null, null, BUY_MARKET));
//            // 取消订单接口
//            System.out.println(service.cancelOrder(1, 160801, CANCEL_ORDER));
            // 获取账号详情
            System.out.println(service.getAccountInfo(ACCOUNT_INFO, null, null));
            // 查询个人最新10条成交订单
            ...
            // 获取订单详情
            System.out.println(service.getOrderInfo(1, 3839979983L, ORDER_INFO));
            // 市价卖出
