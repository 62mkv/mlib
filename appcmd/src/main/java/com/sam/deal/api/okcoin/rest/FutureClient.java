...
import com.sam.deal.api.okcoin.rest.future.IFutureRestApi;
import com.sam.deal.api.okcoin.rest.future.impl.FutureRestApiV1;
...
public class FutureClient {
	...
	public static void main(String[] args) throws HttpException, IOException {
	    ...
	    String api_key = "ab4089d3-0917-4a9d-b461-9ef9554f13cf";  //OKCoin申请的apiKey
       	String secret_key = "82DCE35C15F34F9008D0CB07394BFBC0";  //OKCoin申请的secretKey
		...
		*/
		...
		try {
		JSONObject tradeJSV1 = new JSONObject(tradeResultV1);
