...
bool testLogonAccount()
{
	...
	WindData wd;
	LONG errorCode = CWAPIWrapperCpp::tlogon(wd, L"00000010", L"0", L"M:1391663840901", L"111111", L"SHSZ", L"");
	if (errorCode == 0)
	{
...
void testCancelOrder()
{
	...
	if (errorCode == 0)
	{
		...
		if (lRecordCount > 0)
		{
			...
			errorCode = CWAPIWrapperCpp::tcancel(CT2CW(strOrderNumber));
			if (errorCode == 0)
			{
				cout << "撤单成功" << endl;
			}
