...
/**
 * 
 * Integration tests using the dynamic role manager
 * 
 ...
 * @author rrupp
 */
public class TI_DynamicRoleManager extends AbstractClusterSpecificRoleManagerTest {
    
    @Override
    protected RoleManagerType getRoleManagerType() {
        return RoleManagerType.DYNAMIC;
    }
