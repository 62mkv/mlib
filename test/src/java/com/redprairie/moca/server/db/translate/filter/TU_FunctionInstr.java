 ...
 * @author mlange
 */
public class TU_FunctionInstr extends AbstractMocaTestCase {
    public void testTwoArguments() throws MocaException {   
        String sql;
        
        sql = "select instr('foobar', 'foo') result from dual";
        runTest(sql, "result", 1);
        
        sql = "select instr('foobar', 'fu') result from dual";
        runTest(sql, "result", 0);
        
        sql = "select instr('foobar', 'barx') result from dual";
        runTest(sql, "result", 0);
        
        sql = "select instr('foobar', null) result from dual";
        runTest(sql, "result", null);
        
        sql = "select instr('foobar', '') result from dual";
        runTest(sql, "result", null);
    } 
    ...
    public void testThreeArguments() throws MocaException {   
        ...
        sql = "select instr('foobar', 'foo', -1) result from dual";
        runTest(sql, "result", 1);
        
        sql = "select instr('foobar', 'foo', 1) result from dual";
        runTest(sql, "result", 1);
        
        sql = "select instr('foobar', 'x', 10) result from dual";
        runTest(sql, "result", 0);
        
        sql = "select instr('foobar', 'x', -1) result from dual";
        runTest(sql, "result", 0);
