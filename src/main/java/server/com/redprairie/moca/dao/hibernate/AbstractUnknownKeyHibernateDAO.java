...
import com.redprairie.moca.dao.DAOCriteria;
...
import com.redprairie.util.NotImplementedException;
...
public abstract class AbstractUnknownKeyHibernateDAO<T> 
    ...
    class DAOHibernateCriteria implements DAOCriteria<T> {
        ...
        // @see com.redprairie.ems.dao.DAOCriteria#addEqRestriction(java.lang.String, java.lang.Object)
        public DAOCriteria<T> addEqRestriction(String name, Object value) {
            _criteria.add(Restrictions.eq(name, value));
            return this;
        }

        // @see com.redprairie.moca.dao.DAOCriteria#addNotEqRestriction(java.lang.String, java.lang.Object)
        ...
        // @see com.redprairie.ems.dao.DAOCriteria#addInRestriction(java.lang.String, java.lang.Object[])
        ...
        // @see com.redprairie.ems.dao.DAOCriteria#addNotInRestriction(java.lang.String, java.lang.Object[])
        ...
        // @see com.redprairie.ems.dao.DAOCriteria#addLtRestriction(java.lang.String, java.lang.Object)
        public DAOCriteria<T> addLtRestriction(String name, Object value) {
            _criteria.add(Restrictions.lt(name, value));
            return this;
        }

        // @see com.redprairie.ems.dao.DAOCriteria#addGtRestriction(java.lang.String, java.lang.Object)
        ...
        // @see com.redprairie.ems.dao.DAOCriteria#addSqlRestriction(java.lang.String)
        public DAOCriteria<T> addSqlRestriction(String sql) {
            _criteria.add(Restrictions.sqlRestriction(sql));
            return this;
        }
        
        // @see com.redprairie.moca.dao.DAOCriteria#addOrderByRestriction(java.lang.String, boolean)
        ...
        // @see com.redprairie.ems.dao.DAOCriteria#addNullRestriction(java.lang.String)
        public DAOCriteria<T> addNullRestriction(String name) {
            _criteria.add(Restrictions.isNull(name));
            return this;
        }
        
        // @see com.redprairie.moca.dao.DAOCriteria#addNotNullRestriction(java.lang.String)
        @Override
        ...
        // @see com.redprairie.moca.dao.DAOCriteria#cacheIfAble()
        @Override
