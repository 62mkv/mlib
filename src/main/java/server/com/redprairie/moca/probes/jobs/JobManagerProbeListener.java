...
import com.redprairie.moca.job.JobManagerListener;
...
public class JobManagerProbeListener implements JobManagerListener {
    ...
    // @see com.redprairie.moca.job.JobManagerListener#onStart(com.redprairie.moca.job.JobManager)
    @Override
    public void onStart(JobManager manager) {
        // Nothing to do here
    }

    // @see com.redprairie.moca.job.JobManagerListener#onStop(com.redprairie.moca.job.JobManager)
    @Override
    ...
    // @see com.redprairie.moca.job.JobManagerListener#onRestart(com.redprairie.moca.job.JobManager)
    @Override
    ...
    // @see com.redprairie.moca.job.JobManagerListener#onJobAdded(com.redprairie.moca.job.JobManager, com.redprairie.moca.job.JobDefinition)
    @Override
    public void onJobAdded(JobManager manager, JobDefinition job) {
        addJob(manager, job);
    }

    // @see com.redprairie.moca.job.JobManagerListener#onJobRemoved(com.redprairie.moca.job.JobManager, com.redprairie.moca.job.JobDefinition)
    @Override
    public void onJobRemoved(JobManager manager, JobDefinition job) {
        removeJob(job);
    }

    // @see com.redprairie.moca.job.JobManagerListener#onJobChanged(com.redprairie.moca.job.JobManager, com.redprairie.moca.job.JobDefinition, com.redprairie.moca.job.JobDefinition)
    @Override
    ...
    // @see com.redprairie.moca.job.JobManagerListener#onJobScheduled(com.redprairie.moca.job.JobManager, com.redprairie.moca.job.JobDefinition)
    @Override
    ...
    // @see com.redprairie.moca.job.JobManagerListener#onJobUnscheduled(com.redprairie.moca.job.JobManager, com.redprairie.moca.job.JobDefinition)
    @Override
