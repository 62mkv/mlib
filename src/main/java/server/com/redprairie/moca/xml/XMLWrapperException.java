 ...
 * @version $Revision$
 */
public class XMLWrapperException extends MocaException {

    private static final long serialVersionUID = 7866897504184554621L;
     ...
     */
    public XMLWrapperException(String detail) {
        super(CODE, detail);
    }
     ...
     * @param detail the default error message to use.
     */
    public XMLWrapperException(String detail, Throwable cause) {
