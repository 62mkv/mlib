...
public class NonClusteredRoleManager implements ClusterRoleManager {
    ...
    // @see com.redprairie.moca.cluster.MocaClusterMembershipListener#notifyMembership(com.redprairie.moca.cluster.Node, java.util.List, java.util.List)
    @Override
    ...
    // @see com.redprairie.moca.cluster.manager.ClusterRoleManager#getClusterRoles()
    @Override
    public Multimap<Node, RoleDefinition> getClusterRoles() {
        return HashMultimap.create();
    }

    // @see com.redprairie.moca.cluster.manager.ClusterRoleManager#getClusterNodes(com.redprairie.moca.cluster.RoleDefinition)
    @Override
