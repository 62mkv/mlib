...
package com.redprairie.moca.servlet.spring.interceptors;
...
import com.redprairie.moca.advice.ForwardingDatabaseTool;
import com.redprairie.moca.advice.ForwardingMocaContext;
import com.redprairie.moca.advice.ForwardingServerContext;
...
import com.redprairie.moca.server.log.MocaTraceMessaging;
...
public class MocaHandlerInterceptor implements HandlerInterceptor {
    ...
    private static class WebServiceForwardingServerContext extends ForwardingServerContext {
        ...
        // @see com.redprairie.moca.advice.ForwardingServerContext#getComponentContext()
        @Override
    ...
    private static class WebServiceForwardingMocaContext extends ForwardingMocaContext {
        ...
        // @see com.redprairie.moca.advice.ForwardingMocaContext#commit()
        @Override
        ...
        // @see com.redprairie.moca.advice.ForwardingMocaContext#rollback()
        @Override
        ...
        // @see com.redprairie.moca.advice.ForwardingMocaContext#getDb()
        @Override
    ...
    private static class WebServiceForwardingDatabaseTool extends ForwardingDatabaseTool {
        ...
        // @see com.redprairie.moca.advice.ForwardingDatabaseTool#rollbackDB(java.lang.String)
        @Override
        ...
        // @see com.redprairie.moca.advice.ForwardingDatabaseTool#setSavepoint(java.lang.String)
        @Override
