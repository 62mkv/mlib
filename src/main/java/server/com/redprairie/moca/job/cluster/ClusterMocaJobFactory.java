...
import com.redprairie.moca.job.LocalCommandJob;
import com.redprairie.moca.job.LocalCommandStatefulJob;
import com.redprairie.moca.job.MocaJobFactory;
...
public class ClusterMocaJobFactory extends MocaJobFactory {
    ...
    // @see com.redprairie.moca.job.MocaJobFactory#newJob(org.quartz.spi.TriggerFiredBundle, org.quartz.Scheduler)
    @Override
