...
public class ReplacementElement implements SQLElement {
    ...
    // @see com.redprairie.moca.db.translate.SQLElement#getType()
    public TokenType getType() {
        return _type;
    }

    // @see com.redprairie.moca.db.translate.SQLElement#getValue()
    public String getValue() {
        return _text;
    }
    
    // @see com.redprairie.moca.db.translate.SQLElement#getLeadingWhitespace
