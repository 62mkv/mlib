...
import com.redprairie.moca.server.db.translate.filter.functions.RoundTruncHandler;
import com.redprairie.moca.server.db.translate.filter.mssql.functions.AddMonthsHandler;
import com.redprairie.moca.server.db.translate.filter.mssql.functions.ChrHandler;
import com.redprairie.moca.server.db.translate.filter.mssql.functions.ConcatHandler;
import com.redprairie.moca.server.db.translate.filter.mssql.functions.DateDiffDaysHandler;
import com.redprairie.moca.server.db.translate.filter.mssql.functions.InstrHandler;
import com.redprairie.moca.server.db.translate.filter.mssql.functions.LpadHandler;
import com.redprairie.moca.server.db.translate.filter.mssql.functions.MSDecodeHandler;
import com.redprairie.moca.server.db.translate.filter.mssql.functions.ModHandler;
import com.redprairie.moca.server.db.translate.filter.mssql.functions.MonthsBetweenHandler;
import com.redprairie.moca.server.db.translate.filter.mssql.functions.ReplaceHandler;
import com.redprairie.moca.server.db.translate.filter.mssql.functions.RpadHandler;
import com.redprairie.moca.server.db.translate.filter.mssql.functions.SubstrHandler;
import com.redprairie.moca.server.db.translate.filter.mssql.functions.ToCharHandler;
import com.redprairie.moca.server.db.translate.filter.mssql.functions.ToDateHandler;
import com.redprairie.moca.server.db.translate.filter.mssql.functions.ToNumberHandler;
import com.redprairie.moca.server.db.translate.filter.mssql.functions.TruncHandler;
