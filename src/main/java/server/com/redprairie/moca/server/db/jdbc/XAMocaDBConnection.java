...
class XAMocaDBConnection extends AbstractMocaDBConnection {
    ...
    // @see com.redprairie.moca.server.db.jdbc.MocaConnection#getConnection()
    @Override
    public Connection getConnection() throws SQLException {
        return _connection.getConnection();
    }

    // @see com.redprairie.moca.server.db.jdbc.MocaConnection#close()
    @Override
    ...
    // @see com.redprairie.moca.server.db.jdbc.AbstractMocaDBConnection#getXAResource()
    @Override
