...
import com.redprairie.moca.db.hibernate.HibernateUtils;
...
class SQLServerLimitHandler implements LimitHandler {
    ...
    // @see com.redprairie.moca.server.db.translate.PageLimitHandler#addPageLimit(java.lang.String, int, int, com.redprairie.moca.server.db.BindList, boolean)
    @Override
