...
import com.sam.moca.cluster.ClusterCachable;
...
import com.sam.moca.util.ExceptionSuppressingRunnable;
import com.sam.moca.util.MocaUtils;
import com.sam.util.EnvironmentExpander;
...
public class TaskManager extends ClusterCachable<TaskDefinition> implements ClusterRoleAware {
    ...
    // @see com.sam.moca.cluster.ClusterRoleAware#activateRole(com.sam.moca.cluster.NodeDefinition)
    @Override
    ...
    // @see com.sam.moca.cluster.ClusterRoleAware#deactivateRole(com.sam.moca.cluster.NodeDefinition)
    @Override
    ...
    // @see com.sam.moca.cluster.ClusterRoleAware#noCluster()
    @Override
	...
	// @see com.sam.moca.cluster.ClusterRoleAware#handleMerge(boolean)
