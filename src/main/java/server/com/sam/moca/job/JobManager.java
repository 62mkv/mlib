 ...
 * 
 * Copyright (c) 2016-10 Sam Corporation
 * All Rights Reserved
 * 
 * @author mlange
 */
public class JobManager extends ClusterCachable<JobDefinition> implements ClusterRoleAware {
    ...
    // @see com.sam.moca.cluster.ClusterRoleAware#activateRole(java.lang.String)
    @Override
    ...
    // @see com.sam.moca.cluster.ClusterRoleAware#deactivateRole(java.lang.String)
    @Override
	...
	// @see com.sam.moca.cluster.ClusterRoleAware#handleMerge()
