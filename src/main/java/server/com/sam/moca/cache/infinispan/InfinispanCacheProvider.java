...
import com.sam.moca.cache.MocaCacheProvider;
...
public class InfinispanCacheProvider implements MocaCacheProvider {
    ...
    // @see com.sam.moca.cache.MocaCacheProvider#createCache(java.lang.String, java.util.Map, com.sam.moca.cache.CacheController)
    @Override
...
//                disableClusteringSettings(mocaTaskBuilder);
            ...
            if (clusterName == null) {
                ...
                globalBuilder.globalJmxStatistics().jmxDomain("com.sam.moca.cache");
            }
            ...
            // required info
                ...
                globalBuilder.globalJmxStatistics().jmxDomain("com.sam.moca.cache.cluster");
