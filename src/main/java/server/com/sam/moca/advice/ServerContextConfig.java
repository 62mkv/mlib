...
import com.sam.moca.probes.connections.DatabaseConnectionSummaryProbes;
...
import com.sam.moca.server.db.JDBCAdapter;
import com.sam.moca.server.db.MocaTransaction;
import com.sam.moca.server.db.nodb.NoDBAdapter;
...
public class ServerContextConfig {
        ...
        if (session != null && manager != null) {
            ...
            if (dbAdapter != null) {
                ...
                proxiedDbAdapter = new ForwardingDBAdapter(dbAdapter) {
                     ...
                     * @see com.sam.moca.advice.ForwardingDBAdapter#executeSQL(com.sam.moca.server.db.MocaTransaction, java.lang.String, com.sam.moca.server.db.BindList, com.sam.moca.server.db.BindMode, boolean, com.sam.moca.server.profile.CommandPath)
                     */
                    @Override
    ...
    private static class OurMocaContext extends ForwardingMocaContext {
        ...
        // @see com.sam.moca.advice.ForwardingMocaContext#executeCommand(java.lang.String)
        @Override
        ...
        // @see com.sam.moca.advice.ForwardingMocaContext#executeInline(java.lang.String)
        @Override
        ...
        // @see com.sam.moca.advice.ForwardingMocaContext#executeCommand(java.lang.String, java.util.Map)
        @Override
        public MocaResults executeCommand(String command,
        ...
        // @see com.sam.moca.advice.ForwardingMocaContext#executeInline(java.lang.String, java.util.Map)
        @Override
        public MocaResults executeInline(String command,
            Map<String, ?> args) throws MocaException {
            handleCommandExecution(command);
        ...
        // @see com.sam.moca.advice.ForwardingMocaContext#executeCommand(java.lang.String, com.sam.moca.MocaArgument[])
        @Override
        public MocaResults executeCommand(String command,
        ...
        // @see com.sam.moca.advice.ForwardingMocaContext#executeInline(java.lang.String, com.sam.moca.MocaArgument[])
        @Override
        public MocaResults executeInline(String command,
            MocaArgument... args) throws MocaException {
            handleCommandExecution(command);
    ...
    private static class OurServerContext extends ForwardingServerContext {
        ...
        // @see com.sam.moca.advice.ForwardingServerContext#close()
        @Override
        public void close() {
        ...
        // @see com.sam.moca.advice.ForwardingServerContext#executeCommandWithRemoteContext(java.lang.String, java.util.Collection, java.util.Collection)
        @Override
