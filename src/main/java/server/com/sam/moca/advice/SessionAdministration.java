...
public class SessionAdministration implements SessionAdministrationBean {
    ...
    // @see com.sam.moca.advice.ServerContextAdministrationMXBean#getConnectedIpAddress()
    @Override
    ...
    // @see com.sam.moca.advice.ServerContextAdministrationMXBean#getCommand()
    @Override
    public String getLastCommand() {
        return _lastCommand;
    }
    
    // @see com.sam.moca.advice.ServerContextAdministrationMXBean#getLastScript()
    @Override
    public String getLastScript() {
        return _lastScript;
    }

    // @see com.sam.moca.advice.ServerContextAdministrationMXBean#getLastSqlStatement()
    @Override
    public String getLastSqlStatement() {
        return _lastSqlStatement;
    }
    
    // @see com.sam.moca.advice.ServerContextAdministrationMXBean#getLastCommandTime()
    @Override
    ...
    // @see com.sam.moca.advice.ServerContextAdministrationMXBean#getLastScriptTime()
    @Override
    ...
    // @see com.sam.moca.advice.ServerContextAdministrationMXBean#getLastSqlStatementTime()
    @Override
    ...
    // @see com.sam.moca.advice.SessionAdministrationBean#startTrace(java.lang.String)
    @Override
    ...
    // @see com.sam.moca.advice.SessionAdministrationBean#getStartedTime()
    @Override
    public Date getStartedTime() {
        return _startedTime.toDate();
    }
    
    // @see com.sam.moca.advice.SessionAdministrationBean#getTraceFile()
    @Override
    ...
    // @see com.sam.moca.advice.SessionAdministrationBean#getSessionName()
    @Override
    public String getSessionName() {
        return _session.getSessionId();
    }
    
    // @see com.sam.moca.advice.SessionAdministrationBean#getSessionType()
    @Override
