...
import com.sam.moca.mad.reporters.DatabaseConnectionDumper;
import com.sam.moca.mad.reporters.NativeProcessReporter;
import com.sam.moca.mad.reporters.SessionReporter;
...
public class MonitoringInformation implements MonitoringMBean {
    ...
    // @see com.sam.moca.monitoring.MonitoringMBean#dumpSessionInformation()
    @Override
    public String dumpSessionInformation() {
        return SessionReporter.generateSessionReport();
    }
    
    // @see com.sam.moca.monitoring.MonitoringMBean#dumpDatabaseConnectionInformation()
    @Override
    public String dumpDatabaseConnectionInformation() {
        return DatabaseConnectionDumper.dumpDatabaseConnectionInformation();
    }

    // @see com.sam.moca.monitoring.MonitoringMBean#dumpConnectedUserInformation()
    @Override
    public String dumpConnectedUserInformation() {
        return UserReporter.generateUserReport();
    }
    
    // @see com.sam.moca.mad.MonitoringMBean#dumpNativeProcessInformation()  
    @Override
