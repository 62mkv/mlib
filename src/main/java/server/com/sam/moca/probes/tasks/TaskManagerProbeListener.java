...
import com.sam.moca.task.AbstractTaskManagerListener;
...
public class TaskManagerProbeListener extends AbstractTaskManagerListener {
     ...
     * @see com.sam.moca.task.TaskManagerListener#onStart(com.sam.moca.task.TaskManager)
     */
    @Override
     ...
     * @see com.sam.moca.task.TaskManagerListener#onStop(com.sam.moca.task.TaskManager)
     */
    @Override
     ...
     * @see com.sam.moca.task.TaskManagerListener#onRestart(com.sam.moca.task.TaskManager)
     */
    @Override
     ...
     * @see com.sam.moca.task.TaskManagerListener#onTaskAdded(com.sam.moca.task.TaskDefinition)
     */
    @Override
     ...
     * @see com.sam.moca.task.TaskManagerListener#onTaskChanged(com.sam.moca.task.TaskManager, com.sam.moca.task.TaskDefinition, com.sam.moca.task.TaskDefinition)
     */
    @Override
     ...
     * @see com.sam.moca.task.TaskManagerListener#onTaskRemoved(com.sam.moca.task.TaskDefinition)
     */
    @Override
