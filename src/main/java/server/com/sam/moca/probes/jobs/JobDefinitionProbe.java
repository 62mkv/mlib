...
public class JobDefinitionProbe implements JobDefinitionMXBean {
    ...
    // @see com.sam.moca.probes.jobs.JobDefinitionMXBean#getJobId()
    @Override
    public String getJobId() {
        return _job.getJobId();
    }

    // @see com.sam.moca.probes.jobs.JobDefinitionMXBean#getRole()
    @Override
    public RoleDefinition getRole() {
        return _job.getRole();
    }

    // @see com.sam.moca.probes.jobs.JobDefinitionMXBean#getName()
    @Override
    public String getName() {
        return _job.getName();
    }

    // @see com.sam.moca.probes.jobs.JobDefinitionMXBean#getCommand()
    @Override
    public String getCommand() {
        return _job.getCommand();
    }

    // @see com.sam.moca.probes.jobs.JobDefinitionMXBean#getLogFile()
    @Override
    public String getLogFile() {
        return _job.getLogFile();
    }

    // @see com.sam.moca.probes.jobs.JobDefinitionMXBean#getTraceLevel()
    @Override
    public String getTraceLevel() {
        return _job.getTraceLevel();
    }

    // @see com.sam.moca.probes.jobs.JobDefinitionMXBean#getSchedule()
    @Override
    public String getSchedule() {
        return _job.getSchedule();
    }

    // @see com.sam.moca.probes.jobs.JobDefinitionMXBean#getTimer()
    @Override
    public Integer getTimer() {
        return _job.getTimer();
    }

    // @see com.sam.moca.probes.jobs.JobDefinitionMXBean#getStartDelay()
    @Override
    public Integer getStartDelay() {
        return _job.getStartDelay();
    }

    // @see com.sam.moca.probes.jobs.JobDefinitionMXBean#isOverlap()
    @Override
    public boolean isOverlap() {
        return _job.isOverlap();
    }

    // @see com.sam.moca.probes.jobs.JobDefinitionMXBean#isEnabled()
    @Override
    public boolean isEnabled() {
        return _job.isEnabled();
    }

    // @see com.sam.moca.probes.jobs.JobDefinitionMXBean#getType()
    @Override
    public String getType() {
        return _job.getType();
    }

    // @see com.sam.moca.probes.jobs.JobDefinitionMXBean#getEnvironment()
    @Override
