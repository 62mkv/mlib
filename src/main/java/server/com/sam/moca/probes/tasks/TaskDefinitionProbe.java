...
public class TaskDefinitionProbe implements TaskDefinitionMXBean {
    ...
    // @see com.sam.moca.mad.TaskDefinitionMXBean#getTaskId()
    @Override
    public String getTaskId() {
        return _task.getTaskId();
    }

    // @see com.sam.moca.mad.TaskDefinitionMXBean#getRole()
    @Override
    public RoleDefinition getRole() {
        return _task.getRole();
    }

    // @see com.sam.moca.mad.TaskDefinitionMXBean#getName()
    @Override
    public String getName() {
        return _task.getName();
    }

    // @see com.sam.moca.mad.TaskDefinitionMXBean#getCmdLine()
    @Override
    public String getCmdLine() {
        return _task.getCmdLine();
    }

    // @see com.sam.moca.mad.TaskDefinitionMXBean#getRunDirectory()
    @Override
    public String getRunDirectory() {
        return _task.getRunDirectory();
    }

    // @see com.sam.moca.mad.TaskDefinitionMXBean#getLogFile()
    @Override
    public String getLogFile() {
        return _task.getLogFile();
    }

    // @see com.sam.moca.mad.TaskDefinitionMXBean#getTraceLevel()
    @Override
    public String getTraceLevel() {
        return _task.getTraceLevel();
    }

    // @see com.sam.moca.mad.TaskDefinitionMXBean#isRestart()
    @Override
    public boolean isRestart() {
        return _task.isRestart();
    }

    // @see com.sam.moca.mad.TaskDefinitionMXBean#isAutoStart()
    @Override
    public boolean isAutoStart() {
        return _task.isAutoStart();
    }

    // @see com.sam.moca.mad.TaskDefinitionMXBean#getStartDelay()
    @Override
    public Integer getStartDelay() {
        return _task.getStartDelay();
    }

    // @see com.sam.moca.mad.TaskDefinitionMXBean#getType()
    @Override
    ...
    // @see com.sam.moca.probes.tasks.TaskDefinitionMXBean#getEnvironment()
    @Override
