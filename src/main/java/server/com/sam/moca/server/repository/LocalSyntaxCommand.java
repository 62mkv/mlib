...
public class LocalSyntaxCommand extends Command {
    ...
    // @see com.sam.moca.server.repository.Command#getSyntax()
    public String getSyntax() {
        return _syntax;
    }

    // @see com.sam.moca.server.repository.Command#setSyntax(java.lang.String)
    public void setSyntax(String syntax) {
         _syntax=syntax;
    }
    
    // @see com.sam.moca.server.repository.Command#getType()
    ...
    // @see
    // com.sam.moca.server.repository.Command#execute(com.sam.moca.MocaContext)
    @Override
