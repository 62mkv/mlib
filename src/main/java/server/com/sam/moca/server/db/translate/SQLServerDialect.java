...
import com.sam.moca.server.db.jdbc.ConnectionValidators;
import com.sam.moca.server.db.jdbc.ConnectionValidator;
import com.sam.moca.server.db.jdbc.DefaultDbValidator;
import com.sam.moca.server.db.jdbc.PropertyProvider;
import com.sam.moca.server.db.translate.filter.AutoBindFilter;
import com.sam.moca.server.db.translate.filter.CommentFilter;
...
import com.sam.moca.server.db.translate.filter.mssql.MSEmptyStringFilter;
import com.sam.moca.server.db.translate.filter.mssql.MSForUpdateFilter;
import com.sam.moca.server.db.translate.filter.mssql.MSFunctionFilter;
import com.sam.moca.server.db.translate.filter.mssql.MSOuterJoinFilter;
import com.sam.moca.server.db.translate.filter.mssql.MSRownumFilter;
import com.sam.moca.server.db.translate.filter.mssql.MSSimpleFunctionFilter;
import com.sam.moca.server.db.translate.filter.mssql.MSSimpleWordFilter;
import com.sam.moca.server.db.translate.filter.mssql.NStringLiteralFilter;
import com.sam.moca.server.db.translate.filter.mssql.NVarcharFilter;
import com.sam.moca.server.db.translate.filter.mssql.StringConcatenationFilter;
...
public class SQLServerDialect extends AbstractFilterTranslator {
    ...
    // @see com.sam.moca.db.translate.SQLTranslator#getSequenceValue(java.lang.String, java.sql.Connection)
    @Override
