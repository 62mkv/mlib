...
import com.sam.moca.server.db.jdbc.OracleDataSourcePropertyEditor;
...
public class OraclePropertyProvider extends DefaultPropertyProvider {
    ...
    // @see com.sam.moca.server.db.nodb.PoolListener#initializeDataSourceProperties(javax.sql.CommonDataSource, java.util.Properties)
    @Override
    ...
    // @see com.sam.moca.server.db.jdbc.DefaultPoolListener#getPropertyEditor()
    @Override
