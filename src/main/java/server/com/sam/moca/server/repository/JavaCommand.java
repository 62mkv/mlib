...
import com.sam.moca.server.exec.ComponentAdapter;
...
public class JavaCommand extends Command {
    ...
    // @see com.sam.moca.server.repository.Command#getClassname()
    public String getClassName() {
        return _className;
    }

    // @see
    // com.sam.moca.server.repository.Command#setClassname(java.lang.String)
    public void setClassName(String className) {
        _className = className;
    }

    // @see com.sam.moca.server.repository.Command#getMethod()
    public String getMethod() {
        return _method;
    }

    // @see
    // com.sam.moca.server.repository.Command#setMethod(java.lang.String)
    ...
    // @see
    // com.sam.moca.server.repository.Command#execute(com.sam.moca.server.exec.ServerContext)
    @Override
