...
import com.sam.moca.server.legacy.socket.LocalNativeProcessWrapper;
...
public class SingleProcessNativeAdapterFactory extends AbstractNativeAdapterFactory {
    ...
    // @see com.sam.moca.server.legacy.NativeProcessPool#getServerAdapter(com.sam.moca.server.exec.ServerContext)
    @Override
    ...
    // @see com.sam.moca.server.legacy.NativeProcessPool#start()
    @Override
