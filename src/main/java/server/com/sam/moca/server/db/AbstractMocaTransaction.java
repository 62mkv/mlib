...
import com.sam.moca.server.exec.MocaTransactionManager;
...
public abstract class AbstractMocaTransaction implements MocaTransaction {
    ...
    // @see com.sam.moca.server.db.MocaTransaction#removeAttribute(java.lang.String)
    public Object removeAttribute(String name) {
        return _transactionAttributes.remove(name);
    }
    
    // @see com.sam.moca.server.db.MocaTransaction#getAttribute(java.lang.String)
    public Object getAttribute(String name) {
        return _transactionAttributes.get(name);
    }
    
    // @see com.sam.moca.server.db.MocaTransaction#setAttribute(java.lang.String, java.lang.Object)
    ...
    // @see com.sam.moca.server.db.MocaTransaction#addHook(com.sam.moca.TransactionHook)
    public void addHook(TransactionHook hook) {
        startTransaction();
        _transactionHooks.addFirst(hook);
    }
    
    // @see com.sam.moca.server.db.MocaTransaction#hooks()
    ...
    // @see com.sam.moca.server.db.MocaTransaction#clearAll()
    ...
    // @see com.sam.moca.server.db.MocaTransaction#commit()
    @Override
    ...
    // @see com.sam.moca.server.db.MocaTransaction#rollback()
    @Override
    ...
    // @see com.sam.moca.server.db.MocaTransaction#suspend()
    @Override
    ...
    // @see com.sam.moca.server.db.MocaTransaction#resume()
    @Override
    ...
    // @see com.sam.moca.server.db.MocaTransaction#isOpen()
    @Override
