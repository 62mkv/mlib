...
public abstract class AbstractNativeAdapterFactory 
    ...
    // @see com.sam.moca.server.legacy.NativeAdapterFactory#getNativeAdapter(com.sam.moca.server.exec.ServerContext)
    @Override
    ...
    // @see com.sam.moca.server.legacy.NativeAdapterFactory#initialize()
    @Override
    ...
    // @see com.sam.moca.server.legacy.NativeAdapterFactory#restart()
    @Override
    ...
    // @see com.sam.moca.server.legacy.NativeAdapterFactory#getNativeProcessPool()
    @Override
