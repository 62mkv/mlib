...
import com.sam.moca.server.repository.docs.CommandDocumentationException;
import com.sam.moca.server.repository.docs.DocWriter;
import com.sam.moca.server.repository.file.CommandRepositoryReader.RepositoryReaderEvents;
import com.sam.moca.server.repository.file.xml.XMLRepositoryFileReaderFactory;
...
public class Mbuild {
    ...
    public static class MbuildLogger implements RepositoryReaderEvents {
        ...
        // @see com.sam.moca.server.repository.file.CommandRepositoryReader.RepositoryReaderEvents#reportTriggerOverrideError(java.lang.String)
        @Override
