...
import com.sam.moca.server.db.NamedConnection;
...
public class ConnectionPoolDataSource implements MocaDataSource {
    ...
    // @see com.sam.moca.server.db.jdbc.MocaDataSource#closeAll()
    @Override
    public void closeAll() {
        _pool.shutdown();
    }

    // @see com.sam.moca.server.db.jdbc.MocaDataSource#getIdleConnections()
    @Override
    ...
    // @see com.sam.moca.server.db.jdbc.MocaDataSource#getBusyConnections()
    @Override
    ...
    // @see com.sam.moca.server.db.jdbc.MocaDataSource#getConnectionPoolStatistics()
    @Override
    ...
    // @see com.sam.moca.server.db.jdbc.MocaDataSource#getSize()
    @Override
    public int getSize() {
        return _idleConns.size() + _busyConns.size();
    }

    // @see com.sam.moca.server.db.jdbc.MocaDataSource#getMaxSize()
    @Override
