...
import com.sam.moca.server.repository.docs.CommandDocumentation;
...
public abstract class Command implements Serializable, ExecutableComponent {
    ...
    // @see com.sam.moca.server.exec.ExecutableComponent#execute(com.sam.moca.server.exec.ServerContext)
    @Override
    ...
    // @see com.sam.moca.server.repository.ExecutableComponent#getName()
