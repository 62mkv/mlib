...
import com.sam.moca.server.exec.JavaVariableContext;
...
public class ContextMocaServerAdapter implements MocaContextServerAdapter {
    ...
    // @see com.sam.moca.server.legacy.MocaServerAdapter#executeCommand(java.lang.String, boolean)
    @Override
    ...
    // @see com.sam.moca.server.legacy.MocaServerAdapter#getRegistry(java.lang.String, java.lang.String)
    ...
    // @see com.sam.moca.server.legacy.MocaServerAdapter#getStackArgs()
    @Override
    public MocaArgument[] getStackArgs(boolean getAll) {
        return _ctx.getCommandArgs(getAll, false);
    }

    // @see com.sam.moca.server.legacy.MocaServerAdapter#getStackElement(java.lang.String, java.lang.String)
    ...
    // @see com.sam.moca.server.legacy.MocaServerAdapter#rolbackTx()
    ...
    // @see com.sam.moca.server.legacy.MocaServerAdapter#rollbackDB(java.lang.String)
    ...
    // @see com.sam.moca.server.legacy.MocaServerAdapter#setSaveoint(java.lang.String)
    @Override
    ...
    // @see com.sam.moca.server.legacy.MocaServerAdapter#getCurrentCommandPath()
    @Override
