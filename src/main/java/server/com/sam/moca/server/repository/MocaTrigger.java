...
public class MocaTrigger implements Serializable, Trigger, TriggerOverridable {
    ...
    // @see com.sam.moca.server.repository.Trigger#getName()
    ...
    // @see com.sam.moca.server.repository.Trigger#getCommand()
    ...
    // @see com.sam.moca.server.repository.Trigger#getDescription()
    ...
    // @see com.sam.moca.server.repository.Trigger#getSyntax()
    ...
    // @see com.sam.moca.server.repository.Trigger#getDocumentation()
    ...
    // @see com.sam.moca.server.repository.Trigger#getFileName()
    ...
    // @see com.sam.moca.server.repository.Trigger#getFile()
    ...
    // @see com.sam.moca.server.repository.Trigger#getVersion()
    ...
    // @see com.sam.moca.server.repository.Trigger#getFireSequence()
    ...
    // @see com.sam.moca.server.repository.Trigger#getArguments()
    ...
    // @see com.sam.moca.server.repository.Trigger#getSortSequence()
    ...
    // @see com.sam.moca.server.repository.Trigger#execute(com.sam.moca.server.exec.ServerContext)
    ...
    // @see com.sam.moca.server.repository.TriggerOverridable#overrideTrigger(com.sam.moca.server.repository.Trigger)
    @Override
