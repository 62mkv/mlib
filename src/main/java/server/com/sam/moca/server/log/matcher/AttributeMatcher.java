...
package com.sam.moca.server.log.matcher;

import ch.elca.el4j.services.xmlmerge.Matcher;
import org.jdom.Element;

/**
 * Matcher that matches elements <b>iff</b> their configured attributes match.
 * Any (or both) elements' attributes being null does <b>NOT</b> constitute matching.
 *
...
public class AttributeMatcher implements Matcher {
    ...
    public AttributeMatcher(String attribute) {
