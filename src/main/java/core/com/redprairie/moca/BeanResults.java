...
public class BeanResults<T> implements ModifiableResults {
    ...
    public class BeanIterator implements RowIterator {
        ...
        // @see com.redprairie.moca.MocaResults#next()
        public boolean next() {
        ...
        // @see com.redprairie.moca.MocaResults.getValue(int)
        ...
        // @see com.redprairie.moca.MocaResults.getValue(java.lang.String)
        ...
        // @see com.redprairie.moca.MocaResults#getString(int)
        ...
        // @see com.redprairie.moca.MocaResults#getString(java.lang.String)
        ...
        // @see com.redprairie.moca.MocaResults#getInt(int)
        ...
        // @see com.redprairie.moca.MocaResults#getInt(java.lang.String)
        ...
        // @see com.redprairie.moca.MocaResults#getDouble(int)
        ...
        // @see com.redprairie.moca.MocaResults#getDouble(java.lang.String)
        ...
        // @see com.redprairie.moca.MocaResults#getBoolean(int)
        public boolean getBoolean(int index) {
            Object value = _getValueByIndex(index);
            return _coerceToBoolean(value);
        }

        // @see com.redprairie.moca.MocaResults#getBoolean(java.lang.String)
        public boolean getBoolean(String name) {
            Object value = _getValueByName(name); 
            return _coerceToBoolean(value);
        }

        // @see com.redprairie.moca.MocaResults#getDateTime(int)
        ...
        // @see com.redprairie.moca.MocaResults#getDateTime(java.lang.String)
        ...
        // @see com.redprairie.moca.MocaResults#getResults(int)
        ...
        // @see com.redprairie.moca.MocaResults#getResults(java.lang.String)
    ...
    // @see com.redprairie.moca.MocaResults#reset()
    public void reset() {
        _iterator = new BeanIterator();
    }
    ...
    // @see com.redprairie.moca.MocaResults#getColumnType(int)
    ...
    // @see com.redprairie.moca.MocaResults#getColumnType(java.lang.String)
    ...
    // @see com.redprairie.moca.MocaResults#getMaxLength(int)
    public int getMaxLength(int index) {
        return 0;
    }
    
    // @see com.redprairie.moca.MocaResults#getMaxLength(java.lang.String)
    public int getMaxLength(String name) {
        return 0;
    }

    // @see com.redprairie.moca.MocaResults#isNullable(int)
    ...
    // @see com.redprairie.moca.MocaResults#isNullable(java.lang.String)
    ...
    // @see com.redprairie.moca.MocaResults#getColumnName(int)
    public String getColumnName(int index) {
        return _getColumnName(_properties[index]);
    }

    // @see com.redprairie.moca.MocaResults#getColumnNumber(java.lang.String)
    ...
    // @see com.redprairie.moca.MocaResults#getColumnCount()
    ...
    // @see com.redprairie.moca.MocaResults#close()
    public void close() {
        // Do nothing...no native objects to release.
    }

    // @see com.redprairie.moca.EditableResults#addRow()
    ...
    // @see com.redprairie.moca.EditableResults#setBinaryValue(int, byte[])
    public void setBinaryValue(int num, byte[] value) {
        _setValueByIndex(num, value);
    }

    // @see com.redprairie.moca.EditableResults#setBinaryValue(java.lang.String, byte[])
    public void setBinaryValue(String name, byte[] value) {
        _setValueByName(name, value);
    }

    // @see com.redprairie.moca.EditableResults#setBooleanValue(int, boolean)
    public void setBooleanValue(int num, boolean value) {
        _setValueByIndex(num, Boolean.valueOf(value));
    }

    // @see com.redprairie.moca.EditableResults#setBooleanValue(java.lang.String, boolean)
    public void setBooleanValue(String name, boolean value) {
        _setValueByName(name, Boolean.valueOf(value));
    }

    // @see com.redprairie.moca.EditableResults#setDateValue(int, java.util.Date)
    public void setDateValue(int num, Date value) {
        _setValueByIndex(num, value);
    }

    // @see com.redprairie.moca.EditableResults#setDateValue(java.lang.String, java.util.Date)
    public void setDateValue(String name, Date value) {
        _setValueByName(name, value);
    }

    // @see com.redprairie.moca.EditableResults#setDoubleValue(int, double)
    public void setDoubleValue(int num, double value) {
        _setValueByIndex(num, Double.valueOf(value));
    }

    // @see com.redprairie.moca.EditableResults#setDoubleValue(java.lang.String, double)
    public void setDoubleValue(String name, double value) {
        _setValueByName(name, Double.valueOf(value));
    }

    // @see com.redprairie.moca.EditableResults#setIntValue(int, int)
    public void setIntValue(int num, int value) {
        _setValueByIndex(num, Integer.valueOf(value));
    }

    // @see com.redprairie.moca.EditableResults#setIntValue(java.lang.String, int)
    public void setIntValue(String name, int value) {
        _setValueByName(name, Integer.valueOf(value));
    }

    // @see com.redprairie.moca.EditableResults#setNull(int)
    public void setNull(int num) {
        _setValueByIndex(num, null);
    }

    // @see com.redprairie.moca.EditableResults#setNull(java.lang.String)
    public void setNull(String name) {
        _setValueByName(name, null);
    }

    // @see com.redprairie.moca.EditableResults#setStringValue(int, java.lang.String)
    public void setStringValue(int num, String value) {
        _setValueByIndex(num, value);
    }

    // @see com.redprairie.moca.EditableResults#setStringValue(java.lang.String, java.lang.String)
    public void setStringValue(String name, String value) {
        _setValueByName(name, value);
    }
    
    // @see com.redprairie.moca.ModifiableResults#setResultsValue(int, com.redprairie.moca.MocaResults)
    ...
    // @see com.redprairie.moca.ModifiableResults#setResultsValue(java.lang.String, com.redprairie.moca.MocaResults)
    ...
    // @see com.redprairie.moca.EditableResults#setValue(int, java.lang.Object)
    ...
    // @see com.redprairie.moca.EditableResults#setValue(java.lang.String, java.lang.Object)
