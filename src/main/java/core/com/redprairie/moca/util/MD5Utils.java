...
/**
 * 
 * Utility methods to allow common encryption tools to match the implementation
 * of RedPrairie's legacy misMD5 tool.
 * 
 * The equivalent legacy C code:
 * 
 * <pre>
 * unsigned char data[BUFSIZE];
 * char hash_string[23];
 * . . . 
 * misMD5Data(data, sizeof data, hash_string, sizeof hash_string, 6)
 * </pre>
 * 
 * would be written as:
 * <pre>
 * String keyString = MD5Utils.encode(MessageDigest.getInstance("MD5").digest(data), 6);
 * </pre>
...
public class MD5Utils {
    ...
    /**
     * Hashes the password to MD5 format.
     * 
    ...
    public static final String _hashPipe = "|H|";
