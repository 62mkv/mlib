...
public class InternalNativeProcess implements RemoteNativeProcess {
    ...
    public InternalNativeProcess(String id) {
        String logDir = System.getProperty("com.sam.moca.NativeLog");
        if (logDir != null) {
            try {
    ...
    // @see com.sam.moca.server.legacy.NativeProcess#loadLibrary(java.lang.String, java.lang.String)
    @Override
    synchronized
    ...
    // @see com.sam.moca.server.legacy.NativeProcess#initializeCOMLibrary(java.lang.String)
    @Override
    public MocaLibInfo initializeCOMLibrary(String progID) throws MocaException {
        return _initializeCOMLibrary(progID);
    }
    
    // @see com.sam.moca.server.legacy.NativeProcess#callCOMMethod(com.sam.moca.server.legacy.MocaServerAdapter, java.lang.String, java.lang.String, com.sam.moca.MocaType[], java.lang.Object[])
    @Override
    ...
    // @see com.sam.moca.server.legacy.NativeProcess#setEnvironment(java.lang.String, java.lang.String)
    @Override
