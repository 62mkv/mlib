...
#ifndef SQLDATATYPESORACLE_H
#define SQLDATATYPESORACLE_H
...
#define ERR_INDEX_ALREADY_EXISTS      	    -955
#define ERR_INVALID_COLUMN_NAME             -904
#define ERR_NO_ROWS_AFFECTED               -1403
#define ERR_OBJECT_NOT_FOUND                -942
#define ERR_PRIMARY_KEY_ALREADY_EXISTS     -2260
#define ERR_TABLE_ALREADY_EXISTS            -955
#define ERR_VIEW_ALREADY_EXISTS             -955
 ...
 * Data Types
 */
#define STRING_TY(len)               varchar2(len CHAR)

#ifndef DB_USE_NTYPES
#define NSTRING_TY(len)  varchar2(len CHAR)
#define NCLOB_TY                     clob
#define NLONG_TY                     clob
#define NLARGECHAR_TY                varchar2(4000) 
#else
#define NSTRING_TY(len)  nvarchar2(__MOCA([[len > 2000 ? 2000 : len]]))
#define NCLOB_TY                     nclob
#define NLONG_TY                     nclob
#define NLARGECHAR_TY                nvarchar2(4000) 
#endif
...
#define DROP_PK_CONSTRAINT(tblname, cnsname) \
	  alter table tblname drop constraint cnsname drop index
...
#define RENAME_COLUMN(tabname, old, new) \
           alter table tabname rename column old to new
