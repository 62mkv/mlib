...
//IE Document Mode 9 needs G_vmlCanvasManager to exist, so it is included.
if (!window.CanvasRenderingContext2D || (Ext.isFunction(Ext.isIEDocMode) && (Ext.isIEDocMode(9) || Ext.isIEDocMode(10)))) {
...
(function () {
  ...
  var G_vmlCanvasManager_ = {
    init: function (opt_doc) {
      ...
      if (/MSIE/.test(navigator.userAgent) && !window.opera && doc.namespaces) {
        var self = this;
