...
RP.core.Formats = {
    Date: {
        Long: {
            type: "date",
            order: "y,m,d",
            formatstring: "yyyy年MM月dd日 tt hh':'mm"
        },
        Default: {
            type: "date",
            order: "y,m,d",
        ...
        TimeStamp: {
            type: "date",
            order: "y,m,d",
            formatstring: "yyyy年MM月dd日 tt hh':'mm':'ss"
        },
        FullDateOnly: {
            type: "date",
            order: "m,d,y",
        ...
        FullDateTime: {
            type: "date",
            order: "m,d,y",
            formatstring: "dddd', 'MMMM dd', 'yyyy tt hh':'mm"
        },
        POSDate: {
            type: "date",
            order: "y,m,d",
            formatstring: "yyyy年MM月dd日'T'tt hh':'mm':'ss"
        },
        WeekdayDate: {
            type: "date",
            order: "m,d",
    ...
    Time: {
        Default: {
            type: "time",
            formatstring: "tt hh':'mm"
        },
        Short: {
            type: "time",
            formatstring: "tt h':'mm"
        },
        Long: {
            type: "time",
            formatstring: "tt hh':'mm':'ss"
        },
        Military: {
            type: "time",
            formatstring: "HH':'mm"
