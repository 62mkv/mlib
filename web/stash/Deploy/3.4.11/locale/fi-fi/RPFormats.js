...
RP.core.Formats = { Date: { Long:        { type: "date",
                       ...
                       FullDateTime:    { type: "date",
                                          order:"d,m,y",
                                          formatstring:"d'. 'MMMM'ta 'yyyy HH':'mm':'ss"},
                       POSDate:         { type: "date",
                                          order:"y,m,d",
 ...
 * @singleton
 */
RP.core.FormatConstants =  { Weekdays: ["su","ma","ti","ke","to","pe","la"],
                        FullWeekdays:["sunnuntai","maanantai","tiistai","keskiviikko","torstai","perjantai","lauantai"],
...
Ext.apply(Ext.form.DateField.prototype, {
    format: "d.m.Y",
    altFormats: "d.m.Y|j.n.Y|j.n.y|j.m.y|d.n.y|j.m.Y|d.n.Y|d-m-y|d-m-Y|d.m|d-m|dm|dmy|dmY|d|Y-d-m|j-n|j.n|d/m/y|d/m/Y|d/m|d"
});
