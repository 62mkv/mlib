    ...
    RP.core.Formats = {
        Date: {
            Long: {
                type: "date",
                order: "y,m,d",
                formatstring: "yyyy'" + dateSeparator + "'MM'" + dateSeparator + "'dd hh'" + timeSeparator + "'mm"
            },
            Default: {
                type: "date",
                order: "y,m,d",
            ...
            TimeStamp: {
                type: "date",
                order: "y,m,d",
                formatstring: "yyyy'" + dateSeparator + "'MM'" + dateSeparator + "'dd hh'" + timeSeparator + "'mm'" + timeSeparator + "'ss tt"
            },
            FullDateOnly: {
                type: "date",
                order: "y,m,d",
            ...
            FullDateTime: {
                type: "date",
                order: "y,m,d",
                formatstring: "yyyy', 'MMMM dddd', 'dd hh'" + timeSeparator + "'mm tt"
            },
            POSDate: {
                type: "date",
                order: "y,m,d",
            ...
            WeekdayDate: {
                type: "date",
                order: "m, d",
                formatstring: "ddd, MM" + dateSeparator + "dd"
            },
            ShortDateTime: {
                type: "date",
                order: "m,d",
                formatstring: "MMM dd', 'hh'" + timeSeparator + "'mm tt"
            },
            MediumDateExp: {
                type: "date",
                order: "m,d",
