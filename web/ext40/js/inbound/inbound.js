 ...
 */
function createInboundMenu()
{
                    var inboundmenu = new Ext.create('Ext.menu.Menu',
                            {
                            width: '100%',
                            floating: false,
                            layout:'vbox',
        ...
        au_mntuser = Ext.create('Ext.form.Panel',
                {
                   ...
                   bbar:[
                         ...
                         {xtype:'button',
                                ...
                                handler: function(a,b)
                                {
                                	var usr_id_str = Ext.getCmp("ib_name").value;
                         ...
                         {xtype:'button',
                          ...
                          handler: function(a,b)
                          {
                             ...
                             {
                            	 var clause = " where usr_id ='" + Ext.getCmp("ib_name").value
