...
{
    /// <summary>
    /// A integer mapping delegate class
    /// </summary>
    public class IntegerMappingDelegate : MappingDelegate
    {
        /// <summary>
        ...
        public IntegerMappingDelegate(ColumnMap map)
            : base(map)
        {
        }
        ...
        {
            int value;
            if (Int32.TryParse(data, NumberStyles.Any,
